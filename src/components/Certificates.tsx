          ...
          {certificates.map((cert, index) => (
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-orange-50 to-amber-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                {/* Certificate Image/Icon */}
                <motion.div
                  className="relative w-full h-32 mb-4 rounded-2xl overflow-hidden bg-gradient-to-br from-emerald-50 via-orange-50 to-amber-50 flex items-center justify-center"
                ...
                >
                  {cert.image && !cert.image.includes("example.com") ? (
                    ...
                    (() => {
                      ...
                      return <IconComponent size={48} className="text-emerald-500" />;
                    })()
                  )}
                ...
                <div className="relative z-10">
                  ...
                  {/* Achievement badge */}
                  <motion.div
                    className="mt-4 inline-flex items-center gap-1 bg-gradient-to-r from-emerald-500 to-orange-500 text-white px-3 py-1 rounded-full text-xs font-semibold"
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
                ...
                <div className="absolute top-4 right-4 w-2 h-2 bg-gradient-to-br from-emerald-400 to-orange-500 rounded-full opacity-60 animate-pulse" />
                <div className="absolute bottom-4 left-4 w-1 h-1 bg-gradient-to-br from-orange-400 to-amber-500 rounded-full opacity-40 animate-pulse" style={{ animationDelay: '1s' }} />
              </motion.div>

              {/* Glow effect on hover */}
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-emerald-500/20 via-orange-500/20 to-amber-500/20 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-500 -z-10" />
            </motion.div>
          ))}
        </div>
      </motion.div>
