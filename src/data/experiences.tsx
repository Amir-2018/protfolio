...
const experiences = [
  {
    ...
    tasks: [
      ...
      "Integrated GSM/GPRS communication for real-time data transmission",
      "Designed web and mobile applications for vehicle tracking and route optimization",
      "Managed cloud-based data storage and security for client information",
      "Provided technical support and training for international clients",
      "Contributed to the development of anti-theft solutions and fuel monitoring systems"
    ]
  },
  {
